...
while True:
    ...
    row = frame.shape[1]
    col = frame.shape[0]
    # Significantly larger rectangle size
    cv2.rectangle(frame, (50, 50), (550, 550), (255, 255, 255), 2)  # Increased size of the rectangle
    cv2.imshow("data", frame)
    frame = frame[50:550, 50:550]  # Adjusted ROI to match the new rectangle size
